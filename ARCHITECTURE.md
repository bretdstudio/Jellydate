...
3. Extend the episode browser's automatic eight-item pagination to the root catalogs, add compact media details, then add persistent keyboard-based bridge setup.
