...
typedef enum {
    ...
    JD_PACKET_KEYFRAME_REQUEST = 0x1B,
    JD_PACKET_HOME_REQUEST = 0x20,
    JD_PACKET_HOME_RESPONSE = 0x21,
    JD_PACKET_ITEM_DETAILS_REQUEST = 0x22,
    JD_PACKET_ITEM_DETAILS_RESPONSE = 0x23,
    JD_PACKET_ITEM_ARTWORK_REQUEST = 0x24,
    JD_PACKET_ITEM_ARTWORK_RESPONSE = 0x25
